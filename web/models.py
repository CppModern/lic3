...
class Contact(models.Model):
    ...
    key_info = models.CharField(
        max_length=1000,
        blank=True,
        help_text=_("License Keys information text")
    )
    key_help_link = models.URLField(
        max_length=200, blank=True,
        help_text=_("Link for software Help Button")
    )
...
class Messagebox(models.Model):
    text = models.TextField(
        max_length=10000,
        help_text=_("Text shown when users launch the app"))
